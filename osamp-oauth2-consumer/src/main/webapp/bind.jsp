...
<body>
  <p>
    ...
    scopes=
    <br />
    state=<%=Constants.STATE_BIND%>
    </code>
  </p>
  <div style="display:inline-block; border:1px solid;"><a href="<%=oreq.getLocationUri()%>">Proceed Authorication</a></div>
</body>
</html>
